...
void Rectangle::draw(GraphicsContext* gc)
{
	...
	{
		/*
		 * Again making the assumption that the user is entering the points such that the
		 * one closest to the origin is first, and it goes up, not down, call fill and fill in the rectangle
		 */
		gc->fill(x[0]+1, y[0]+1,verticies[0].color);
	}
}
