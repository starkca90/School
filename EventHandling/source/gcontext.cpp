...
void GraphicsContext::bFill(int x, int y, int color)
{
...
void GraphicsContext::fFill(int x,int y,int seedColor)
{
	int pixColor = getPixel(x,y);
	if(pixColor == seedColor)
	{
		setPixel(x,y);
		// Check Right Pixel
		fFill(x+1,y,seedColor);
		// Check Top Pixel
		fFill(x,y+1,seedColor);
		// Check Left Pixel
		fFill(x-1,y,seedColor);
		// Check Bottom Pixel
		fFill(x,y-1,seedColor);
